...
import { generateCaseReport } from "../lib/exportCsv";
...
export default function CaseDetail({ c, author, onClose, onEdit, onDelete }) {
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mbody">
          ...
          <div className="detail-actions">
            <button className="btn sm pri" disabled={reporting}
              onClick={async () => { setReporting(true); try { await generateCaseReport(c, author, fus, media); } finally { setReporting(false); } }}>
              {reporting ? "Preparing report…" : "Patient report (PDF)"}
            </button>
